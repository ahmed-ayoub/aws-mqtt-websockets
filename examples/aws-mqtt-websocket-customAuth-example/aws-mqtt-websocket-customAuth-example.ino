...
void subscribe()
{
    //subscript to a topics
    int delta = client->subscribe(aws_topic, MQTT::QOS0, messageArrived);
    if (delta != 0)
    {
...
void setup()
{
    ...
    awsWSclient.setAWSCustomAuthName(aws_custom_auth_name);
    awsWSclient.setAWSCustomHeaderName(aws_custom_header_name);
    awsWSclient.setAWSCustomToken(aws_custom_token_value);
    awsWSclient.setAWSCustomSignature(aws_custom_token_value);
    awsWSclient.setUseSSL(true);
    awsWSclient.setUseCustomAuth(true);
